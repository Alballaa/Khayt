 ...
 *
 * Only the last 12 months are kept. This lives in the store, which syncs and is
 * backed up; an unbounded per-call log would grow without limit for a number
 * nobody reads at that granularity.
 */
