...
(function (global) {
  ...
  const api = { analyze, convert, fsPreview, analyzeColorBands, readMembers, detectFlavour, extractFilaments, extractMeta, computeBounds, extractTriangles, extractTrianglesWithPaint, extractPlates, platePalettes, fitWarnings };
