...
(function (global) {
  ...
  function _extractCore(members, wantPaint) {
    ...
    return wantPaint ? { triangles: soup, paint: paintOut, objIds: objOut } : soup;
  }
  ...
  const api = { analyze, convert, readMembers, detectFlavour, extractFilaments, extractMeta, computeBounds, extractTriangles, extractTrianglesWithPaint, extractPlates, fitWarnings };
