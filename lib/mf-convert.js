...
(function (global) {
  ...
  const api = { analyze, convert, fsPreview, analyzeColorBands, readMembers, detectFlavour, extractFilaments, extractMeta, computeBounds, countTriangles, extractTriangles, extractTrianglesWithPaint, extractPlates, platePalettes, fitWarnings };
