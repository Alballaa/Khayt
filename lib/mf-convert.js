...
(function (global) {
  ...
  // Spider-Man poster whose 20 meshes inflate to 1168 MB. It fitted under the budget by
  // every measure a maker can see and still lost two objects — 240 MB of geometry — to a
  ...
  function convert(buf, opts = {}) {
    ...
    // A convert that drops two of twenty objects still opens, still slices and still
