...
(function (global) {
   ...
   *
   * BUDGETED because the whole catalog is one blob against a 25 MB server
   * limit. Three per listing at 200 KB is roughly 600 KB, leaving room for
   * forty listings without going near it.
   *
  ...
  const api = { KINDS, KIND_KEYS, DEFAULT_KIND, normalise, apply, syncView, makePrimary, remove, setKind, hasRealPhoto, storefrontPhotos, imageId };
