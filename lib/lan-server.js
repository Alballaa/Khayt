...
setTimeout(()=>location.reload(),30000);
        ...
        // ── Online intake form ──────────────────────────────────
          ...
          const sendIntakeForm = (sessionToken) => {
            ...
            res.end(renderIntakeFormPage(shopName, lanEscapeHtml(store.settings?.currency || '')));
          };
