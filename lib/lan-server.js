...
const { estimateFromStl } = require('./stl-estimate.js');
...
say(head+'<br>'+detail+'<br><span style="font-size:.8rem;">This is an indication, not a confirmed quote. We will confirm before any work starts.</span>','#ecfdf5','#065f46');}
