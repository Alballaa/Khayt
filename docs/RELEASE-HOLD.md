...
|---------|----------------|-------|
| **Stable** | **v2.3.3** | [Latest release](https://github.com/Alballaa/Khayt/releases/latest) |
| **Beta** | **v2.4.0-beta.2** | [Pre-releases](https://github.com/Alballaa/Khayt/releases) — Khayt-4 + security pass; see [BETA-RELEASE.md](./BETA-RELEASE.md) |
