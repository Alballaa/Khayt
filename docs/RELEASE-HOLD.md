...
|---------|----------------|-------|
| **Stable** | **v2.3.2** | [Latest release](https://github.com/Alballaa/Khayt/releases/latest) |
| **Beta** | **v2.4.0-beta.1** | [Pre-releases](https://github.com/Alballaa/Khayt/releases) — Khayt-4 themes; see [BETA-RELEASE.md](./BETA-RELEASE.md) |
