...
| **Beta / RC** | `v3.7.0-beta.14` (`v3.7.0-beta.15` being cut — the promotion candidate; **beta.14 cannot accept a catalogue photo**) | [Pre-releases](https://github.com/khaytapp/Khayt/releases) (filter *Pre-release*) | Opt-in via Settings |
