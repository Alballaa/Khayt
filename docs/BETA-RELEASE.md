...
| **Beta** | `v3.6.0-beta.16` | [Pre-releases](https://github.com/khaytapp/Khayt/releases) (filter *Pre-release*) | Opt-in via Settings |

> Verified 2026-08-10 against published tags. These rot fast — check with
