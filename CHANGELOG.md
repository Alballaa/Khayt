...
- Split from `app.js`: `util.js`, `currency.js`, `calculator-cost.js`, `build.js`, `inventory.js`, `machines.js`, `clients.js`, `expenses.js`, `waste.js`, `views.js`, `notifications.js`, `app-state.js`, `shell.js`, `wire-events.js`, `app-helpers.js`, `ops-locations.js`, `operations-extras.js`, `integrations.js`, `app-exports.js`, `app-boot.js`, `kanban.js`, `invoicing.js`, `logs.js`, `settings.js`, `order-flows.js`, `waiting-list.js`, `dashboard.js`, `analytics.js` (with unit tests).
