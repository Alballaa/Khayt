...
- [ ] Split `renderer/app.js` into feature modules (started: `app-state`, `shell`, `build`, `wire-events`, `app-boot`, `app-exports`, …; next: inventory/catalog or integrations splits)
