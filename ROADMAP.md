...
## Now (post-3.6.0, 3.7.0-beta.19 published — on `main`)
...
**`v3.7.0-beta.19` is PUBLISHED** (2026-09-01). A shop can give
...
**The newest *published* pre-release is `v3.7.0-beta.19`** (2026-09-01) — all
