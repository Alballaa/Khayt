...
- [ ] Split `renderer/app.js` into feature modules (started: `app-state`, `shell`, `build`, `wire-events`, `app-boot`, `app-exports`, `integrations`, …; next: inventory/catalog or BNPL/LAN helpers)
